    ...
    def retranslateUi(self, Start):
        ...
        self.message.setText(
            QCoreApplication.translate(
                "Start", u"<strong>Select Spreadsheets</strong>", None
            )
        )
        self.instruction.setText(
            QCoreApplication.translate(
                "Start",
                u"= Student Training Records =\n  \n= Not Completed =  \n\n\n [Hold ctrl & click to add both]",
                None,
            )
        )
        self.select_button.setText(
            QCoreApplication.translate("Start", u"Select .xlsx Files", None)
        )
