...
basepath = Path.cwd()
xlsx_path = f"{basepath}/data/interim_data/healthandsafety.xlsx"
csv_save = f"{basepath}/data/interim_data/healthandsafety.csv"
Xlsx2csv(xlsx_path, outputencoding="utf-8").convert(csv_save)


course_str_data = pd.read_csv(f"{basepath}/data/interim_data/healthandsafety.csv")
